...
class CustomColor {
    ...
    func getDefaultName(with color: UIColor) -> String {
...
let myColor = CustomColor(with: UIColor(red: 0.0/255.0, green: 0.0/255.0, blue: 255.0/255.0, alpha: 1.0))

print(myColor.defaultName)
